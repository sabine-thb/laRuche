...
<section>
    <a href="competition.php?action=classement&id=<?php echo $_GET['id']; ?>" class="retourClass">Retour au
        classement</a>
</section>
    ...
    <div class="flexContainerProfil">
        ...
        <div id="competActive">
            ...
            <?php foreach ($competActive as $tuple) { ?>
                <div class="one-compet labelequipe" style="display: flex;text-align: center">
                    <!--attention 'oneCompet' est deja utilisé dans un css-->
                    <h2 class="nameCompet">
                        <?php echo $tuple['nom']; ?>
                    </h2>
