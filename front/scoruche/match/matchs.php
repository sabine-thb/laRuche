<section class="secPronos">
    ...
    <form class="formPronostics" action="competition.php?action=validationProno&id=<?php echo $_GET['id']; ?>"
          method="post">
                ...
                <div class="Carte">
                    ...
                    <div class="selectionFinale">
                        ...
                        <div>
                            ...
                            <input class="" type="radio" id="<?php echo $tuple['match_id']; ?>_equipe1"
                                   name="<?php echo $tuple['match_id']; ?>_toggle" value="'equipe1'" checked/>
                        </div>

                        <div>
                            <label for="<?php echo $tuple['match_id']; ?>_equipe2"><?php echo $tuple['nom2']; ?></label>
                            <input class="" type="radio" id="<?php echo $tuple['match_id']; ?>_equipe2"
                                   name="<?php echo $tuple['match_id']; ?>_toggle" value="'equipe2'" checked/>
                        </div>
