...
DROP DATABASE IF EXISTS laruchxsabine;

DROP TABLE IF EXISTS laruchxsabine.LaRuche_users;
DROP TABLE IF EXISTS laruchxsabine.LaRuche_admin;
DROP TABLE IF EXISTS laruchxsabine.LaRuche_competition;
DROP TABLE IF EXISTS laruchxsabine.LaRuche_equipe;
DROP TABLE IF EXISTS laruchxsabine.LaRuche_matchApronostiquer;
DROP TABLE IF EXISTS laruchxsabine.LaRuche_pronoQuestionBonus;
DROP TABLE IF EXISTS laruchxsabine.LaRuche_pronostiqueur;
DROP TABLE IF EXISTS laruchxsabine.LaRuche_resultatMatch;
DROP TABLE IF EXISTS laruchxsabine.LaRuche_pronostique;
DROP TABLE IF EXISTS laruchxsabine.LaRuche_resultatQuestionBonus;
DROP TABLE IF EXISTS laruchxsabine.LaRuche_questionBonus;

CREATE DATABASE laruchxsabine;
USE laruchxsabine;
...
BEGIN
    ...
    DECLARE myCursor CURSOR FOR SELECT P.pronostiqueur_id
                                FROM LaRuche_pronostiqueur P
                                         INNER JOIN LaRuche_pronoQuestionBonus LRpQB
