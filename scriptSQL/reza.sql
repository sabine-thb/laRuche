...
BEGIN
    ...
    WHILE i <= 150
        DO
            ...
            INSERT INTO users (login, mail, description, password, age) VALUE ('clone', 'clone@clone.com',
...
BEGIN
    ...
    LOOP
        ...
        UPDATE LaRuche.LaRuche_pronostiqueur
        SET total_point = LaRuche.totalPoint(idTemp, idCompet)
        WHERE pronostiqueur_id = idTemp;
    END LOOP;
